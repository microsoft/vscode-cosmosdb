...
/** A set of sparse documents — each has a different subset of fields. */
export const sparseDocumentsArray: WithId<Document>[] = [
    ...
    { _id: new ObjectId(), email: 'grace@example.com', score: 78, description: 'Enthusiastic about art and design.' },
