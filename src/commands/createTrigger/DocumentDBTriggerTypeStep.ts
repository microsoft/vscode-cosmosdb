...
import { getTriggerType } from '../../docdb/fs/TriggerFileDescriptor';
import { type CreateTriggerWizardContext } from './CreateTriggerWizardContext';

export class DocumentDBTriggerTypeStep extends AzureWizardPromptStep<CreateTriggerWizardContext> {
