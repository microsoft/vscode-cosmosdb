...
export const exportSourcePaths = [
    './src',
    './node_modules/@microsoft/vscode-azext-utils/out/src',
    './node_modules/@microsoft/vscode-azext-azureutils/out/src',
    './node_modules/@microsoft/vscode-azext-azureauth/out/src',
];
