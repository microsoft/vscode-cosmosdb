...
describe('ResultPage', () => {
    ...
    it('shows the producing model discreetly beside feedback, and nothing when it is unknown', () => {
        const { unmount } = renderResult({ ...recommendation, modelName: 'GPT-4o' });
        const caption = screen.getByText('Generated by GPT-4o');
        expect(caption).toBeVisible();
        const feedback = screen.getByRole('group', { name: 'Recommendation feedback' });
        expect(feedback.parentElement).toContainElement(caption);
        expect(feedback).not.toContainElement(caption);
        unmount();
