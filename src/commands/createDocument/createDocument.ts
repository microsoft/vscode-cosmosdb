...
import { ItemTab } from '../../panels/ItemTab';
...
export async function cosmosDBCreateItem(
    ...
    ItemTab.render(createNoSqlQueryConnection(node), 'add', undefined, vscode.ViewColumn.Active);
}
