...
- Fixed cancelled Cosmos DB Shell install and update operations to exit silently instead of showing a misleading failure notification. (#3322)
- Fixed Fabric artifact tree items to use the Cosmos DB product icon in light and dark themes. (#3324)
...
- Added **Monaco autocompletion** for the Azure Cosmos DB NoSQL query language, providing context-aware suggestions for keywords, built-in functions, and identifiers based on the connected container's schema. (#2968)
