...
export const generateThemeContext = (useAdaptive: boolean, themeKind: string) => {
    return {
        fluentUI: {
...
export const WithTheme = ({ children, useAdaptive = false }: PropsWithChildren<{ useAdaptive?: boolean }>) => {
