...
export async function getPostgresCredentials(context: IActionContext, treeItem?: PostgresServerTreeItem | GenericTreeItem): Promise<void> {
    if (!treeItem) {
    ...
    await (<PostgresServerTreeItem>treeItem).promptForCredentials();
