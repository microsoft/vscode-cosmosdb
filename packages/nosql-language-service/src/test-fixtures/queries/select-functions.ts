    ...
    },
    {
        ...
        expectAst: {
            select: {
                spec: {
                    kind: 'SelectListSpec',
                    items: [{ expression: { kind: 'BinaryScalarExpression', operator: 'Add' }, alias: { value: 'priceWithTax' } }],
                },
            },
        },
    },
    ...
    },
    {
        ...
        expectAst: {
            select: {
                spec: {
                    kind: 'SelectListSpec',
                    items: [{ expression: { kind: 'FunctionCallScalarExpression', name: { value: 'DateTimeAdd' } }, alias: { value: 'expiresAt' } }],
                },
            },
        },
    },
    {
        ...
        expectAst: {
            select: {
                spec: {
                    kind: 'SelectListSpec',
                    items: [{ expression: { kind: 'FunctionCallScalarExpression', name: { value: 'DateTimePart' } }, alias: { value: 'year' } }],
                },
            },
        },
    },
