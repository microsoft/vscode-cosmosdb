    ...
    const runQuery = useCallback(
        async (event?: KeyboardEvent) => {
            ...
            if (state.querySelectedValue) {
                return dispatcher.runQuery(state.querySelectedValue, { countPerPage: state.pageSize, throughputBucket: state.selectedThroughputBucket });
            }

            return dispatcher.runQuery(state.queryValue, { countPerPage: state.pageSize, throughputBucket: state.selectedThroughputBucket });
        },
        [dispatcher, state],
    );
