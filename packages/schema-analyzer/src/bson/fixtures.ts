...
/** Helper to create a document with a fresh ObjectId. */ export function makeDoc(
    fields: Record<string, unknown> = {},
): WithId<Document> {
    return { _id: new ObjectId(), ...fields };
}
/** A flat document exercising every BSON type the analyzer knows about. */ export const flatDocument: WithId<Document> =
    {
        _id: new ObjectId(),
...
/** A document made entirely of embedded sub-documents. */ export const embeddedDocumentOnly: WithId<Document> = {
    _id: new ObjectId(),
    personalInfo: {
        name: 'John Doe',
        age: 29,
    ...
    jobInfo: { company: 'Tech Inc.', role: 'Software Engineer', salary: 80000 },
};
/** A document with arrays of many different element types. */ export const arraysWithDifferentDataTypes: WithId<Document> =
    {
        _id: new ObjectId(),
...
/** A deeply nested document with objects in arrays in objects. */ export const complexDocument: WithId<Document> = {
    _id: new ObjectId(),
    user: {
        username: 'john_doe',
...
/** A document where a normally-object field is a primitive (schema traversal edge-case). */ export const complexDocumentWithOddTypes: WithId<Document> =
    {
        _id: new ObjectId(),
        user: true,
        history: {
...
/** All complex fixtures combined for multi-document tests. */ export const complexDocumentsArray: WithId<Document>[] =
    [flatDocument, embeddedDocumentOnly, arraysWithDifferentDataTypes, complexDocument];
/** A set of sparse documents ΓÇö each has a different subset of fields. */ export const sparseDocumentsArray: WithId<Document>[] =
    [
        ...
        { _id: new ObjectId(), name: 'Frank', isActive: false, score: 56 },
        {
            _id: new ObjectId(),
        ...
        { _id: new ObjectId(), name: 'Heidi', age: 32, isActive: true },
        {
            _id: new ObjectId(),
        ...
        { _id: new ObjectId(), name: 'Judy', age: 28, isActive: false, score: 74 },
        { _id: new ObjectId(), name: 'Ken', age: 38, email: 'ken@example.com' },
    ];
