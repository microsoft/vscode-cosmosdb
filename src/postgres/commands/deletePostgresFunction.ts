...
export async function deletePostgresFunction(
    ...
    const message: string = vscode.l10n.t('Are you sure you want to delete function "{0}"?', treeItem.label);
    ...
    const deleteMessage: string = vscode.l10n.t('Successfully deleted function "{0}".', treeItem.label);
