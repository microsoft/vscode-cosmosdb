...
## 0.15.0 - 2020-09-14
### Added
- PostgreSQL support to Attached Accounts
- PostgreSQL support to API
...
### Fixed
- [Bugs fixed] (https://github.com/microsoft/vscode-cosmosdb/issues?q=is%3Aopen+is%3Aissue+milestone%3A0.15.0)
