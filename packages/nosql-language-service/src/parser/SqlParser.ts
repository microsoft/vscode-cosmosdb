...
// ---------------------------------------------------------------------------
// Helpers — must be null-safe because during Chevrotain grammar recording
// phase, CONSUME/SUBRULE returns stubs (undefined/NaN properties).
// ---------------------------------------------------------------------------

function pos(token: IToken | undefined): SourcePosition {
    return {
...
function posEnd(token: IToken | undefined): SourcePosition {
    return {
...
function range(start: IToken | undefined, end: IToken | undefined): SourceRange {
    return { start: pos(start), end: posEnd(end) };
}

function rangeFromNodes(
    first: AST.SqlNodeBase | undefined,
    last: AST.SqlNodeBase | undefined,
...
function rangeStartEnd(startNode: { range?: SourceRange } | undefined, endToken: IToken | undefined): SourceRange {
    return {
