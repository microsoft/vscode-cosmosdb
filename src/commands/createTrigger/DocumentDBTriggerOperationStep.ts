...
import { getTriggerOperation } from '../../docdb/fs/TriggerFileDescriptor';
import { type CreateTriggerWizardContext } from './CreateTriggerWizardContext';

export class DocumentDBTriggerOperationStep extends AzureWizardPromptStep<CreateTriggerWizardContext> {
