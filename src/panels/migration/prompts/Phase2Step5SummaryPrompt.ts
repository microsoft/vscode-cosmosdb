...
thinking, or commentary before the heading.`,
            ...
            vscpp(
                ...
                vscpp(TextChunk, { priority: 90, breakOn: /\s+/g }, this.props.domainFileList || '(no domain files)'),
                ...
                vscpp(TextChunk, { priority: 70, breakOn: /\s+/g }, this.props.crossDomainEdges || '(none detected)'),
                vscpp(TextChunk, { priority: 65 }, '\n\n# Cross-Domain Dependency Strategies\n\n'),
                vscpp(TextChunk, { priority: 60, breakOn: /\s+/g }, this.props.crossDomainStrategies || '(none)'),
                vscpp(TextChunk, { priority: 55 }, '\n\n# Per-Domain Recommendations\n\n'),
                vscpp(TextChunk, { priority: 50, breakOn: /\s+/g }, this.props.domainRecommendations || '(none)'),
            ),
        );
    }
}
