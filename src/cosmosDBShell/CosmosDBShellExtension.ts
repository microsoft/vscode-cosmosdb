 ...
 */
const MIN_DOTNET_SDK_VERSION = '10.0.203';
 ...
 */
const REQUESTED_DOTNET_SDK_CHANNEL = MIN_DOTNET_SDK_VERSION.split('.').slice(0, 2).join('.');
 ...
 */
function compareDotNetVersions(a: string, b: string): number {
 ...
 */
function getInstalledDotNetSdkVersions(dotnetPath?: string): string[] {
    try {
...
function hasRequiredDotNetSdk(dotnetPath?: string): boolean {
