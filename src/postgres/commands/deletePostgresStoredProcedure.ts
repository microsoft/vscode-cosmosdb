...
export async function deletePostgresStoredProcedure(
    ...
    const message: string = vscode.l10n.t('Are you sure you want to delete stored procedure "{0}"?', treeItem.label);
    ...
    const deleteMessage: string = vscode.l10n.t('Successfully deleted stored procedure "{0}".', treeItem.label);
