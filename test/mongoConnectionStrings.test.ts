...
function testDatabaseNameFromConectionString(connectionString: string, expectedDatabaseName: string | undefined) {
    ...
    if (databaseName) {
        testDatabaseToAccountConnectionString(connectionString, databaseName, connectionString);
    }
}
...
suite(`mongoCollectionStrings`, () => {
    test(`getDatabaseNameFromConnectionString`, () => {
        ...
        testDatabaseNameFromConectionString(`mongodb://a/b?c`, "b");
        testDatabaseNameFromConectionString(`mongodb://my-mongo:ayO83FFfUoHE97Jm7WbfnpNCqiF0Yq0za2YmvuLAKYJKf7h7hQaRKWfZfsv8Ux41H66Gls7lVPEKlKm0ueSozg==@your-mongo.documents.azure.com:10255/?ssl=true&replicaSet=globaldb`, undefined);
    ...
    test('addDatabaseToAccountConnectionString', () => {
        testDatabaseToAccountConnectionString(`mongodb://a.b.c/?readPreference=secondary&maxStalenessSeconds=1201`, 'realdatabase', 'mongodb://a.b.c/realdatabase?readPreference=secondary&maxStalenessSeconds=1201');
